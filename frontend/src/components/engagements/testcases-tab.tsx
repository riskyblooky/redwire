            ...
            >
                ...
                {col('links') && <TableCell>
                    <div className="flex items-center gap-3">
                        ...
                        <LinkTooltip icon={<Server className="h-3.5 w-3.5" />} count={testcaseInfraItems.length} items={testcaseInfraItems.map((i: any) => ({ name: i.name }))} label="Infrastructure" colorClass="text-orange-400" />
