                        ...
                        <Card className="border-slate-800 bg-slate-900/50 backdrop-blur-xs overflow-hidden">
                            ...
                            <CardContent className="p-0">
                                <div className="p-5 space-y-4">
                                    {/* Description Section */}
                                    <section>
                                        <button type="button" onClick={() => toggleSec('summary')} className="flex items-center gap-2 mb-2 text-white w-full text-left">
                                    ...
                                    {/* Remediation Section */}
                                    <section>
                                        <button type="button" onClick={() => toggleSec('remediation')} className="flex items-center gap-2 mb-2 text-white w-full text-left">
